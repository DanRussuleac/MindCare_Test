...
app.post('/api/bot/:conversationId/send', verifyToken, async (req, res) => {
  ...
  try {
    ...
    const completion = await api.chat.completions.create({
      ...
      messages: [
        { role: 'system', content: 'You are an AI assistant who knows everything. You are pretending to be a therapist(do not mention this) and work as a chatbot, try to be as humane and empathic as possible' },
